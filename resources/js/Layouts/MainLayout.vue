<template>
  <header class="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 w-full"> 
    <div class="container mx-auto"> 
      <nav class="p-4 flex items-center justify-between">
        ...
        <div class="text-xl text-indigo-900 dark:text-indigo-600 ">  
  ...
  <main class="container mx-auto p-4">
    <div v-if="flashSuccess" class="mb-4 border rounded-md shadow-sm border-green-200 bg-green-50 p-2 dark:border-green-800 dark:bg-green-800">
      {{ flashSuccess }}
    </div>
    <slot>Default</slot>
  </main>
...
//Declaring and initializing a reactive 
//Proxy object
// const timer = ref(0)
